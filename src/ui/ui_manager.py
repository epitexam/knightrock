...
class UIManager:
    ...
    def draw_state_panel(
        ...
        return self.player_ui.draw_state_panel(x, y, player, layout=layout, panel_id=PANEL_STATE)

    def draw_stats_panel(
        self, x: int, y: int, player: Any, layout: PanelLayout | None = None
    ) -> int:
        return self.player_ui.draw_stats_panel(x, y, player, layout=layout, panel_id=PANEL_STATS)
    ...
    def draw_legend_panel(self, x: int, y: int, layout: PanelLayout | None = None) -> int:
        ...
        lines = [
            ...
            "green     hurtbox (single zone)",
            "zone      thin = plain",
            "zone      thick+fill = xmult boost",
            "zone      dashed seal = guarded",
    ...
    def draw_performance_panel(
        ...
        if layout is not None:
            # Same reservation as draw_panel makes, so the pinned slot is the
            # exact size of the closable panel drawn into it.
